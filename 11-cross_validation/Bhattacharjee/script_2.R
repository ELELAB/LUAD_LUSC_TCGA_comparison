...
dat1Collapsed <- read.csv("/Users/ele/elena/cross-val/Bhattacharjee/collapsed_data.csv", row.names = 1)

# retain only the genes of interest
#gene_list <- c("MUC5","MUC21","KCNK5","ICA1","CSTA","P2RY1","ANXA8","FZD7",
               "CHST7","RND3","ACOX2","ALDOC","ARSE","FABP5","SLC2A9","SPDEF")
gene_list <- c("CSTA","ANXA8","ALDOC","ARSE")
