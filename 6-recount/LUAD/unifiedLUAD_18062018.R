...
eset.gtex<-assays(luad.recount.gtex$GTEX_lung, round = TRUE)$counts
eset.tcga<-assays(luad.recount.tcga$TCGA_lung, round = TRUE)$counts
...
####Normalization- GC content done in another script######
###RECOUNT2####


# #####Normlization and filtering is done by another script "DE_unified_LUAD.R"
...
#                                     qnt.cut =  0.25)
# 
# save(eset.all.NF, file="luad_NF.RData")
