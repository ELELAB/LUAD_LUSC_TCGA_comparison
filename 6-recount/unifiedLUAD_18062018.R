...
####Saving data
save(eset.tcga.normal, file="./LUAD/tcga_normal_luad.RData")
save(eset.tcga.cancer, file="./LUAD/tcga_cancer_luad.RData")
save(eset.gtex, file="./LUAD/gtex.RData")
save(tcga.metadata, file="./LUAD/tcga_meta_luad.RData")
save(gtex.metadata, file="./LUAD/gtex_meta_luad.RData")
head(gtex.metadata)
