...
####Saving data
save(eset.tcga.normal, file="./LUSC/tcga_normal_lusc.RData")
save(eset.tcga.cancer, file="./LUSC/tcga_cancer_lusc.RData")
save(eset.gtex, file="./LUSC/gtex.RData")
save(tcga.metadata, file="./LUSC/tcga_meta_lusc.RData")
save(gtex.metadata, file="./LUSC/gtex_meta_lusc.RData")
...
# #####Normlization and filtering is done by another script "DE_unified_LUSC.R"
# eset.all.N<-TCGAanalyze_Normalization(tabDF = eset.all[!duplicated(rownames(eset.all)), !duplicated(colnames(eset.all))],
#                                                geneInfo = geneInfoHT,
#                                                method = "gcContent")
# 
# 
...
#                                     qnt.cut =  0.25)
# 
# save(eset.all.NF, file="lusc_NF.RData")
