...
#------------ get final cleaned genes list--------------------------

dir <- "/data/user/marta/pipeline/DE/LUAD_LUSC_May2018/VennDiagram_methods/VennDiagram_LUAD-LUSC/"

setwd("/data/user/marta/pipeline/DE/LUAD_LUSC_May2018/VennDiagram_methods/VennDiagram_LUAD-LUSC/final_genes")

#------------ LUAD-up-paired vs LUSC-up-all-----------

up_paired_LUAD <- read.table(paste0(dir,"no_overlap_up_paired_LUAD_only.txt"))
up_all_LUSC <- read.table(paste0(dir,"no_overlap_up_all_LUSC_only.txt"))
...
down_paired_LUAD <- read.table(paste0(dir,"no_overlap_down_paired_LUAD_only.txt"))
down_all_LUSC <- read.table(paste0(dir,"no_overlap_down_all_LUSC_only.txt"))
...
up_paired_LUSC <- read.table(paste0(dir,"no_overlap_up_paired_LUSC_only.txt"))
up_all_LUAD <- read.table(paste0(dir,"no_overlap_up_all_LUAD_only.txt"))
...
down_paired_LUSC <- read.table(paste0(dir,"no_overlap_down_paired_LUSC_only.txt"))
down_all_LUAD <- read.table(paste0(dir,"no_overlap_down_all_LUAD_only.txt"))
