#extract m1_luad
m1_luad <- read.table("/Users/ele/elena/CEMiTool_summary/modules/m1_luad.txt")
...
write.table(trrust_m1luad_final,"/Users/ele/elena/tf/TF-TARGET_int/m1_luad_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m2_luad
m2_luad <- read.table("/Users/ele/elena/CEMiTool_summary/modules/m2_luad.txt")
...
write.table(trrust_m2luad_final,"/Users/ele/elena/tf/TF-TARGET_int/m2_luad_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m3_luad
m3_luad <- read.table("/Users/ele/elena/CEMiTool_summary/modules/m3_luad.txt")
...
write.table(trrust_m3luad_final,"/Users/ele/elena/tf/TF-TARGET_int/m3_luad_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m4_luad
m4_luad <- read.table("/Users/ele/elena/CEMiTool_summary/modules/m4_luad.txt")
...
write.table(trrust_m4luad_final,"/Users/ele/elena/tf/TF-TARGET_int/m4_luad_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)
