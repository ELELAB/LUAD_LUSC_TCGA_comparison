...
#extract m1_lusc
m1_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m1_lusc.txt")
...
#second filter to retain TARGETS - module 1 lusc
...
write.table(trrust_m1lusc_final,"./TF-TARGET_int/m1_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m2_lusc
m2_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m2_lusc.txt")
...
write.table(trrust_m2lusc_final,"./TF-TARGET_int/m2_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m3_lusc
m3_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m3_lusc.txt")
...
write.table(trrust_m3lusc_final,"./TF-TARGET_int/m3_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m4_lusc
m4_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m4_lusc.txt")
...
write.table(trrust_m4lusc_final,"./TF-TARGET_int/m4_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m5_lusc
m5_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m5_lusc.txt")
...
write.table(trrust_m5lusc_final,"./TF-TARGET_int/m5_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)

#extract m6_lusc
m6_lusc <- read.table("../8-coexpression/CEMiTool_summary/modules/m6_lusc.txt")
...
write.table(trrust_m6lusc_final,"./TF-TARGET_int/m6_lusc_TFvsTARGET.txt", sep="\t", quote=FALSE, row.names = FALSE)
